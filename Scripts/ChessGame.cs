...
public partial class ChessGame : Node
{
	...
	[Export]
	private string enginePath = "Assets/ChessEngines/stockfish/stockfish.exe";
	...
	public override void _Ready()
	{
		...
		engineConnector.ConnectToEngine(enginePath);
	...
	public override void _Process(double delta)
	{
		...
		switch (gameState)
		{
			...
			case GameState.AnimationJustFinished:
				...
				int positionCount = board.GetPositionCount(positionKey);
				...
				else if (positionCount >= 3)
				{
					gameEndLabel.Text = drawString;
					gameEndLabel.Visible = true;
					GD.Print("Draw by 3-fold repetition!");
					sounds["GameEnd"].Play();
					gameState = GameState.GameEnd;
				}
